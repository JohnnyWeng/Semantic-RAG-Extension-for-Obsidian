...
To solve this, I created this local, privacy-first Obsidian extension. It reads your notes and generates an offline vector database using the bge-m3 model via Ollama. Instead of looking for exact word matches, it searches by concept and meaning, instantly finding the top 7 most conceptually similar paragraphs in your vault and linking you directly to them. This significantly reduces the time spent searching for notes.
